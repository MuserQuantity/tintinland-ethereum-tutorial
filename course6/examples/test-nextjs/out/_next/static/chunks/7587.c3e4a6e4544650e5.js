"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[7587],{97587:function(o,r,c){c.r(r),c.d(r,{default:function(){return $}});var e=c(5372);c(67294);const l=e.C`
    :after {
...
`,d=e.C`
    ...
    ${l}
`;var s={ButtonColoredStyled:(0,e.s)(e.B)`
    :after {
    ...
    ${({color:o})=>o&&(o=>{switch(o){case"red":return n;case"green":return t;case"blue":return a;case"yellow":return d;default:return}})(o)}
`};const{ButtonColoredStyled:u}=s,$=({color:o,...r})=>(0,e.j)(u,{color:o,...r})}}]);